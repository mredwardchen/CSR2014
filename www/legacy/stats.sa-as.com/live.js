...
var vs="DID="+DID;
	...
	sniffer = new Image(); 
	sniffer.src = 'https:\/\/stats.sa-as.com\/index.php?'+vs+'&'+vsr+'&'+vsd+'&'+purl+'&Fla='+flaver+'&r='+rand;
...
function VSLT(LinkName) {
	...
	sniff = new Image(); 
	sniff.src= 'https:\/\/stats.sa-as.com\/index.php?DID='+DID+'&LinkName='+LinkName+'&r='+random;
}
...
function msrec(e) {
	...
	msxy.src= 'https:\/\/stats.sa-as.com\/tm.php?r='+rand+'&DID='+DID+'&pw='+pw+'&ph='+ph+'&msx='+msx+'&msy='+msy+'&mspage='+window.location.pathname.substring(window.location.pathname.lastIndexOf('\\') + 1);
}
